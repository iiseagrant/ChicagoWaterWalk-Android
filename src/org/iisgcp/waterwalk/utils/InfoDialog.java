...
public class InfoDialog extends GenericDialog {
     ...
     */
    public static InfoDialog newInstance(Activity activity, String dialogTitle, String dialogText) {
     ...
     * @returns A new instance of InfoDialog.
     */
    public static InfoDialog newInstance(Activity activity, String dialogTitle, String dialogText, String altDialogText) {
    	InfoDialog frag = new InfoDialog();
    ...
    public void onStart() {
    	...
    	if (mAltDialogText != null) {
    		...
    		message.setContentDescription(mAltDialogText);
    	}
    }
}
